...
class BlogController extends Controller {
	...
	public function publicar() {
      ...
      die();
			...
			require_once('../app/views/includes/header.php');
    	require_once('../app/views/admin/publicar.php');
    	require_once('../app/views/includes/footer.php');
		}
	}
	...
	public function guardarPublicacion($datos) {
		...
		$directorio = 'portadas/'; #Directorio donde guardamos las img
	...
	public function leerArticulo() {
		require_once('../app/views/includes/header.php');
    	require_once('../app/views/pages/leerArticulo.php');
    	require_once('../app/views/includes/footer.php');
	}
	...
	public function resultadoBusqueda() {
		require_once('../app/views/includes/header.php');
    	require_once('../app/views/pages/resultadoBusqueda.php');
    	require_once('../app/views/includes/footer.php');
	}
